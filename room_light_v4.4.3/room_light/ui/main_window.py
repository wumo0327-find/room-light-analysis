...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("建筑室内采光分析工具  v4.4.3  |  成本约束光热择优版")
    ...
    def _update_title(self):
        ...
        suf = f"  —  {fn}" if fn else ""
        self.setWindowTitle(f"建筑室内采光分析工具  v4.4.3{suf}")
    ...
    def _run_complex_analysis(self):
        ...
        for source_space in spaces:
            ...
            def _run_daylight(
                ...
                _xs, ys, _mask = build_workplane_grid(
                    target, FULL_ANALYSIS_GRID_MM)
                total_rows = len(ys)
    ...
    def _run_experiment(self, params: dict):
        ...
        def _run_exp(progress_cb):
            ...
            df = annotate_minimum_intervention(
                ...
                criterion=params.get("minimum_criterion", "light_thermal"),
            )
