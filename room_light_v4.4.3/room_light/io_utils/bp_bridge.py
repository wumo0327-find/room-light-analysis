...
def building_from_document(
    ...
    *,
    ...
    for space in new_spaces:
        ...
        space.roof_exposed = bool(previous.roof_exposed)
        space.floor_exposed = bool(previous.floor_exposed)
        ...
        space.metadata["boundary_conditions_explicit"] = bool(
            previous.metadata.get("boundary_conditions_explicit", False)
        )
