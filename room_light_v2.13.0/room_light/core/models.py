"""
core/models.py — Data models  v2.13.0
...
#          cost=遮阳板单位长度造价占位值（元/延米，含材料+加工+安装的粗略量级，
#               v2.13.0 新增）。**同样是占位值不是真实报价**：仅按"混凝土便宜、
#               铝板/胡桃木贵、松木/涂料居中"的常识给出相对高低，使参数化实验里
#               "换材料"在成本轴上有区分度（此前成本只随板长L变化、与材料无关，
#               导致采光×成本图上不同材料完全重叠、只显示最后画的那种）。论文需要
#               严谨成本时应替换为实际厂家报价。遮阳算例总成本≈基础安装费+L(米)×cost。
MATERIAL_LIBRARY = {
    "混凝土类": {
        "深色/多孔混凝土":   {"reflect": 0.16, "k_diff": 0.20, "color": "#78716c", "cost": 100.0},
        "密实混凝土":        {"reflect": 0.32, "k_diff": 0.30, "color": "#a8a29e", "cost": 120.0},
        "白色反射涂料混凝土": {"reflect": 0.65, "k_diff": 0.46, "color": "#d6d3d1", "cost": 150.0},
    },
    "金属类": {
        "深色阳极氧化铝板":   {"reflect": 0.30, "k_diff": 0.28, "color": "#1d4ed8", "cost": 280.0},
        "普通/氧化铝板":     {"reflect": 0.50, "k_diff": 0.38, "color": "#3b82f6", "cost": 240.0},
        "镜面高反射铝板":    {"reflect": 0.78, "k_diff": 0.55, "color": "#93c5fd", "cost": 380.0},
    },
    "木材类": {
        "深色木材(胡桃木)":  {"reflect": 0.20, "k_diff": 0.23, "color": "#92400e", "cost": 320.0},
        "浅色木材(松木)":    {"reflect": 0.40, "k_diff": 0.34, "color": "#d97706", "cost": 180.0},
    },
    "涂料/其他类": {
        "深色涂料":         {"reflect": 0.15, "k_diff": 0.18, "color": "#166534", "cost": 130.0},
        "反射隔热白涂料":    {"reflect": 0.85, "k_diff": 0.58, "color": "#22c55e", "cost": 170.0},
    },
}
