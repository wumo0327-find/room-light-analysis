...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("建筑室内采光分析工具  v2.12.0  |  益阳默认气象")
    ...
    def _update_title(self):
        ...
        suf = f"  —  {fn}" if fn else ""
        self.setWindowTitle(f"建筑室内采光分析工具  v2.12.0{suf}")
    ...
    def _run_experiment(self, params: dict):
        ...
        total      = len(specs) + len(tilt_degs) * len(depth_mms)
        ...
        def _run_exp(progress_cb):
            ...
            return run_all_experiments(
                ...
                depth_mms=depth_mms,
                diffuse_residual=params["diffuse_residual"],
                overhang_gap_mm=params["overhang_gap_mm"],
                glass_specs=specs, progress_cb=_pcb)
