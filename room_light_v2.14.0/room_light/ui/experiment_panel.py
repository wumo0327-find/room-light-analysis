"""
ui/experiment_panel.py — 参数化实验结果显示面板  v2.14.0
========================================================
...
from PyQt6.QtWidgets import (
    ...
    QFileDialog, QMessageBox, QCheckBox, QPlainTextEdit,
)
...
class ExperimentPanel(QWidget):
    ...
    def _update_selection_note(self):
        ...
        if self._plot_stack.currentIndex() == 1:
            self._selection_note.setPlainText(global_selection_summary(
                self._df,
    ...
    def export_png(self):
        ...
        if not out_dir:
            return
        try:
            written = self.save_pngs(out_dir)
