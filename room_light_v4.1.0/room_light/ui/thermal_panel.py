"""
ui/thermal_panel.py — 热环境分析结果面板  v4.1.0
    ...
    def _update_kpi(
        ...
        if comparison is not None:
            comparison_vals = {
                ...
                "comfort": str(comparison.comfort_months),
                "overheat": str(comparison.overheat_months),
                "underheat": str(comparison.underheat_months),
            }
