"""
core/legacy_adapter.py — legacy rectangle RoomModel to v4 complex model adapter.

Keeping this conversion explicit allows old rectangle projects to use the v4
geometry/audit pipeline without changing their clear internal dimensions.
"""
...
def building_from_room(
    ...
    """Convert one legacy rectangle into a valid v4 building hierarchy."""
    ...
    for window in room.windows:
        ...
        # The old north direction already matches the complex CCW loop.  Old east
    ...
    space = SpaceModel(
        ...
        analysis_floor_loops=[FloorLoop(
            points=list(points),
            kind="outer",
            id="legacy_net_floor",
            metadata={
                "source": "legacy_room_dimensions",
                "basis": "legacy dimensions are clear internal dimensions",
            },
        )],
