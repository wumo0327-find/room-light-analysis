...
class OperatingPriorityDecisionTests(unittest.TestCase):
    ...
    def test_energy_saving_retrofit_excludes_baseline_from_recommendation(self):
        ...
        self.assertEqual(chosen["decision_kind"], "节能改造最小残余差距")
    ...
    def test_baseline_remains_eligible_when_no_retrofit_saves_operation_cost(self):
        frame = pd.DataFrame([
            {
                "solution_id": "B001",
                "group": "原始模型基准",
        ...
        chosen = assessed[assessed["decision_recommended"]].iloc[0]
        self.assertEqual(chosen["solution_id"], "B001")
        self.assertEqual(
