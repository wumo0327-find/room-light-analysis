"""
ui/experiment_panel.py — 参数化实验结果显示面板  v4.2.2
========================================================
...
显示两种视图（顶部按钮切换）：
  ...
  · 3D点云：Cd × 热不舒适度 × 工程造价估算三轴固定透视图，三个坐标面的范围和
...
class ExperimentPanel(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._result_table.setHorizontalHeaderLabels([
            "方案", "材料", "倾角", "板长", "间隙", "Cd / Ra", "热指标", "造价", "精度", "结论",
        ])
        ...
        self._plot3d_hint = QLabel(
            "运行实验后此处显示固定透视3D帕累托点云；三个面的坐标范围与"
            "对应二维图完全一致")
    ...
    def _face_specs(self):
        ...
        return [
            ...
            (light_key, True, "cost", False, light_label, "工程造价估算（元）",
             "采光 × 工程造价"),
