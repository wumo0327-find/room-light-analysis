"""
ui/complex_space_editor.py — Manual complex-space editor  v3.3.0
...
class ComplexSpaceCanvas(QWidget):
    ...
    def refresh(self) -> None:
        ...
        if wall is None and storey is not None:
            ...
            axis.set_title(
                f"{building.name} — {storey.name}｜点击房间多选，右键单选",
                fontsize=14,
                fontweight="bold",
                color="#1e3a8a",
            )
        ...
        for loop in space.boundary_loops:
            ...
            for wall in loop.segments:
                ...
                axis.plot(
                    ...
                    color=wall_color,
                    linewidth=3.1 if is_active else 2.2,
