"""
core/daylight.py — Daylight Factor & Illuminance Engine  v2.10.1
==============================================================
...
def _fin_slots_full_m(room: RoomModel, wall: str):
    ...
    if D0 > 0.0 and wins[0].x > 1e-6:
        slots.append((0.0, wins[0].x / 1e3, D0, wins[0].sill / 1e3, wins[0].head / 1e3))
    ...
    if Dlast > 0.0 and wins[-1].right < axis_len_mm - 1e-6:
        slots.append((wins[-1].right / 1e3, axis_len_mm / 1e3, Dlast,
